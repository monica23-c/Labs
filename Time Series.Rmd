...
<li>The best visualization depended on the types of variables - for instance, bargraphs were best for a single categorical variable, histograms were best for a single numerical variable, and scatterplots were best for two numerical variables. All of these plots could be faceted to accommodate an additional categorical variable.</li>
...
<li><span style="color: red;"> Which variables need to be mutated to be of the correct type?</span></li>

<li>You do not need to worry about cleaning the data to complete this lab.</li>
